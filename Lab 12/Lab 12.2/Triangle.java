public class Triangle {
    ...
    public double getPerimeter(){
        ...
        double d2 = Math.sqrt(Math.pow(vertice2.getX()-vertice3.getX(), 2)+Math.pow((vertice2.getY()-vertice3.getY()), 2));
        double d3 = Math.sqrt(Math.pow(vertice3.getX()-vertice1.getX(), 2)+Math.pow((vertice3.getY()-vertice1.getY()), 2));
        return d1 + d2 + d3;
    }
}
